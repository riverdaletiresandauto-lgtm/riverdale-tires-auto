...
const WHY = [
  {
    icon: Clock,
    title: "18 years on the road",
    text: "25,000+ calls answered with a 30–45 minute average arrival time.",
  },
  {
    icon: Handshake,
    title: "Honest, upfront help",
    text: "Clear pricing before we roll a truck — no surprises, no hidden fees.",
  },
  {
    icon: Award,
    title: "4.9-star service",
    text: "Rated by thousands of stranded drivers who called us at their worst moment.",
  },
  {
    icon: TrendingUp,
    title: "One call, total coverage",
    text: "Tires, battery, lockout, fuel and towing — a single number handles it all.",
  },
];
    ...
    <>
          ...
          <div>
            ...
            <FadeUp delay={0.24}>
              <p className="mt-4 max-w-xl leading-relaxed text-muted-foreground">
                Eighteen years later, that promise hasn&apos;t changed. We&apos;ve grown to a
                12-person team with eight service vehicles — but every call still gets the same
                fast, friendly, honest treatment it did on day one.
              </p>
            </FadeUp>
          </div>
          <FadeUp delay={0.2}>
      ...
      <section className="section-pad !pt-8">
        <div className="container-site">
          <SectionHeading eyebrow="Why Riverdale" title="Four reasons drivers call us first" />
      ...
      <section className="section-pad !pt-8">
        <div className="container-site">
          <SectionHeading
            ...
            subtitle="Technicians, drivers and dispatchers who treat every call like family."
          />
